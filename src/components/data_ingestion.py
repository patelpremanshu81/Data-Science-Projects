...
from src.config import MYSQL, RAW_DATA_DIR
from src.entity.config_entity import DataIngestionConfig
from src.entity.artifact_entity import DataIngestionArtifact
from src.exception import PricePredictorException
...
def ingest_data() -> DataIngestionArtifact:
    """Try to read from MySQL table; if fails, fallback to CSV at C:/Users/Lenovo/Downloads/laptop_price.csv"""
    try:
        ...
        try:
            ...
            df=pd.read_csv("C:/Users/Lenovo/Downloads/laptop_price.csv")
